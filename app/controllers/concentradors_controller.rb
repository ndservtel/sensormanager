class ConcentradorsController < ApplicationController
  ...
  private
    ...
    def concentrador_params
      params.require(:concentrador).permit(:categoria_equipos_id, :nombre, :descripcion, :estado, :gis_latitud, :float, :gis_longitud, :mac_address, :numero_serie, :ip_address, :ip_port)
    end
end
